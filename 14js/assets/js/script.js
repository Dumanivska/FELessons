...
function changeForm() {
    ...
    btnIn.addEventListener('click', (e) => {
        formAccount.style.border = '2px solid purple';
        formAccount.style.display = 'flex';
        formAccount.style.background = '#521AAB';
        formRegistration.style.display = "none";
    })
    btnUp.addEventListener('click', (e) => {
        formAccount.style.display = 'none';
        formRegistration.style.display = "flex";
        formRegistration.style.background = '#521AAB';
        formRegistration.style.border = "2px solid purple"
    })
}